...
export const ChatLayout = () => {
  ...
  const modelMeta = MODEL_META[selectedModel] ?? {
    label: selectedModel,
    color: "#6366f1",
  };
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* User panel */}
            <div
              style={{ padding: "10px 12px", borderTop: `1px solid ${border}` }}
            >
              <div
                style={{
                  borderRadius: 12,
              ...
              >
                {booting ? (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p style={{ color: muted, fontSize: 14, margin: 0 }}>
                        ...
                        <span
                          style={{ color: modelMeta.color, fontWeight: 600 }}
                        >
                          {modelMeta.label}
                        </span>
                        .
                  ...
                  >
                    ...
                    {loading &&
                      !messages.find((m) => m._id === streamingMessageId)
                        ?.content && (
                        <div
                          style={{
                            display: "flex",
                ...
                >
                  <div style={{ position: "relative", minWidth: 120 }}>
                    ...
                    >
                      <option
                        value="nvidia"
                        style={{ background: isDark ? "#1e202c" : "white" }}
                      >
                        NVIDIA NIM
                      </option>
                      <option
